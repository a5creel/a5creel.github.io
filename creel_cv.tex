...
\begin{longtable}{>{\bfseries}r p{0.85\linewidth}} % r (right) for dates, X (expandable) for details
...
\begin{longtable}{>{\bfseries}r p{0.85\linewidth}} % r (right) for year, X (expandable) for presentations
...
\begin{longtable}{>{\bfseries}r p{0.85\linewidth}} % r (right) for year, X (expandable) for awards
