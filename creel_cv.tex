...
\raggedbottom % allow pages to end at variable heights
...
\titlespacing*{\section}{0pt}{1ex plus 0.5ex minus 0.2ex}{1ex plus 0.2ex}
...
\textit{Dissertation Title: Essays in Natural Resource Economics}
...
\begin{longtable}{>{\bfseries}r p{5.5in}} % r (right) for dates, X (expandable) for details
...
\begin{longtable}{>{\bfseries}r p{5.5in}}% r (right) for year, X (expandable) for presentations
...
\begin{longtable}{>{\bfseries}r p{5.5in}}% r (right) for year, X (expandable) for awards
...
2025 & \textbf{Instructor, Certificate in Environmental Data Science, Yale School of the Environment} \\
    ...
    & \textbf{Graduate Teaching Fellow, ENV 762, Yale School of the Environment} \\
...
2024 & \textbf{Graduate Teaching Fellow, ENV 617, Yale School of the Environment} \\
...
\begin{longtable}{>{\bfseries}r p{5.5in}}% r (right) for dates, X (expandable) for details
    ...
    2025 - Present & \textbf{Founder and Board member of YEEHAW} (Yale Environmental Economics Has a Workshop) \\
    & Founded with the mission to build a strong alumni network and foster research collaboration across cohorts of graduates from the Yale School of the Environment\\
...
\begin{itemize}
    \item \textbf{Prof. Eli P. Fenichel}\\
    \textit{Knobloch Family Professor of Natural Resource Economics}\\
    Yale School of the Environment \\
    \href{mailto:eli.fenichel@yale.edu}{eli.fenichel@yale.edu} \\
    (203) 432-5114
    \item  \textbf{Prof. Kenneth Gillingham}\\
    \textit{Senior Associate Dean of Academic Affairs; Grinstein Class of 1954 Professor of Environmental and Energy Economics}\\
    Yale School of the Environment\\
    \href{mailto:kenneth.gillingham@yale.edu}{kenneth.gillingham@yale.edu}\\
    (203) 436-5465
    \item \textbf{Prof. Arianna Salazar-Miranda} \\
    \textit{Assistant Professor of Urban Planning and Data Science} \\
    Yale School of the Environment\\
    \href{mailto:arianna.salazar-miranda@yale.edu}{arianna.salazar-miranda@yale.edu}\\
    (203) 436-4569
\end{itemize}
